...
% ===================================================================
\begin{ex}
	\immini{Một nhóm học sinh thực hiện thí nghiệm đo nhiệt nóng chảy riêng của nước đá. Bộ thí nghiệm gồm: biến áp nguồn, bộ đo công suất (oát kế) có tích hợp chức năng đo thời gian, nhiệt kế điện tử có thang đo từ \SI{-20}{\celsius} đến \SI{110}{\celsius}, độ phân giải $\pm \SI{0.1}{\celsius}$, hiệt lượng kế, cân điện tử, các dây nối. Ban đầu, nhóm cho một viên nước đá và một ít nước lạnh vào bình nhiệt lượng kế, cắm nhiệt kế vào bình, khuấy đều hỗn hợp cho đến khi nhiệt kế chỉ \SI{0}{\celsius}. Lấy viên nước đá ra cân thì số chỉ của cân là \SI{22.80}{{\gram}}. }{\begin{tabular}{|M{3cm}|M{3cm}|M{3cm}|}
			\hline
			\thead{Thời gian $\left(\si{\second}\right)$} &\thead{Công suất $\left(\si{\watt}\right)$} &\thead{Nhiệt độ $\left(\si{\celsius}\right)$}\\
			\hline
			$60$ &$14,05$ &$0$\\
			\hline
			$120$ &$14,06$ &$0$\\
			...
			\hline
	\end{tabular}}
Sau đó, bỏ viên đá vào lại nhiệt lượng kế, sao cho toàn bộ điện trở chìm trong hỗn hợp nước và nước đá, bật công tắc nguồn, khuấy nhẹ, ghi lại số chỉ của bộ đo công suất và thời gian sau các khoảng 60 giây vào bảng. Khi thời gian là 300 giây, lấy viên đá ra cân thì số chỉ của cân là \SI{10.58}{\gram}.
	\choiceTF[t]
	{\True Trong quá trình nước đá tan, nhiệt độ hỗn hợp không đổi}
	{\True Trong quá trình nước đá tan, nội năng của hỗn hợp tăng lên}
	{Thực tế, trong quá trình nước đá tan, hỗn hợp nước và nước đá tỏa nhiệt ra môi trường xung quanh}
	{Từ bảng số liệu của nhóm, tính được nhiệt nóng chảy riêng trung bình của nước đá là \SI{3.44E3}{\joule/\kilogram}}
	\loigiai{
	\begin{enumerate}[label=\alph*)]
		\item Đúng.
		\item Đúng.
		\item Sai. Nhận nhiệt chứ không phải tỏa nhiệt.
		\item Sai.\\
		$\overline{\calP}=\dfrac{14,05+\dots+13,98}{5}=\SI{14.022}{\watt}$.\\
		$\lambda=\dfrac{\overline{\calP}\cdot t}{\Delta m}=\dfrac{14,022\cdot 300}{\left(22,80-10,58\right)\cdot 10^{-3}}\approx\SI{3.44E5}{\joule/\kilogram}$.
	\end{enumerate}
	}
\end{ex}
% ===================================================================
...
% ===================================================================
\begin{ex}
	\immini{Một nhóm học sinh thực hiện thí nghiệm khảo sát sự nóng chảy của nước đá bằng các dụng cụ thí nghiệm sau đây:
		\begin{itemize}
			\item Bộ nguồn điện có công suất không đổi và có tích hợp đo thời gian.
			\item Nhiệt lượng kế bằng nhựa có vỏ xốp kèm dây điện trở ở bên trong bình.
			\item Nhiệt kế.
		\end{itemize}
		Trong quá trình tiến hành thí nghiệm, nhóm học sinh thu thập số liệu. Học sinh vẽ được đồ thị phụ thuộc của nhiệt độ theo thời gian. Khi vẽ đồ thị theo một tỉ lệ xích quy định thì xác định được các góc $\alpha \approx \SI{60.0}{\degree}$, $\beta \approx \SI{40.8}{\degree}$. Biết nhiệt dung riêng của nước là $c_{\mathrm{n}}=\SI{4200}{\joule/\left(\kilogram\cdot\kelvin\right)}$.}{\includegraphics[scale=0.3]{figs/G12Y24B5-6}}
	\choiceTF[t]
	{Nước đá (ở trạng thái rắn) là chất rắn vô định hình}
	{\True Trong quá trình nước đá nóng chảy thì nội năng của nước đá tăng lên}
	{Nhiệt dung riêng của nước đá (ở trạng thái rắn) đo được xấp xỉ bằng \SI{2039}{\joule/\left(\kilogram\cdot\kelvin\right)}}
	{\True Nhiệt nóng chảy riêng của nước đá xấp xỉ bằng \SI{3.35E5}{\joule/\kilogram}}
	\loigiai{
	\begin{enumerate}[label=\alph*)]
		\item Sai. Nước đá là chất rắn kết tinh.
		\item Đúng. Trong quá trình nóng chảy thì thể tích của nước đá giảm nên thế năng tương tác phân tử tăng $\Rightarrow$ nội năng của nước đá tăng lên.
		\item Sai. 
		$T_1=\dfrac{20}{\tan\alpha}=\dfrac{20}{\tan\SI{60}{\degree}}=\xsi{\dfrac{20}{\sqrt{3}}}{\minute}$\\
		$\calP\Delta T_{\mathrm{n}}=mc_\mathrm{n}t\Rightarrow \dfrac{\calP}{m}=\dfrac{c_\mathrm{n}t}{\Delta T_\mathrm{n}}=c_\mathrm{n}\cdot\tan\beta=4200\cdot\tan\SI{40.8}{\degree}\approx3625,34$\\
		Ta lại có:
		$\begin{cases}
			\calP\cdot T_1=mc_\mathrm{d}\cdot20\\
			\calP\cdot\left(9T_1-T_1\right)=m\lambda
		\end{cases}\Rightarrow \dfrac{\calP}{m}=\dfrac{c_\mathrm{d}\cdot 20}{T_1}=\dfrac{\lambda}{8T_1}\Rightarrow 3625,34=\dfrac{c_\mathrm{d}\cdot20}{\dfrac{20}{\sqrt{3}}}=\dfrac{\lambda}{8\cdot\dfrac{20}{\sqrt{3}}}\Rightarrow\begin{cases}
		c_\mathrm{d}\approx\SI{2093}{\joule/\left(\kilogram\cdot\kelvin\right)}\\
		\lambda\approx\SI{3.35E5}{\joule/\kilogram}
		\end{cases}$.
		\item Đúng.
	\end{enumerate}
	}
...
% ===============================================================
\begin{ex}
	\immini{Cung cấp nhiệt lượng cho một khối băng (nước đá), người ta thu được đồ thị biểu diễn nhiệt độ của nước theo nhiệt lượng cung cấp được mô tả như Hình bên. Dựa vào đồ thị, hãy tính nhiệt lượng cần cung cấp để đun sôi nước đá ở \SI{0}{\celsius} đến nhiệt độ sôi theo đơn vị \si{\kilo\joule}.}{\vspace{-0.5cm}\includegraphics[scale=0.4]{figs/G12Y24B5-5}}
	\shortans[oly]{40}
	\loigiai{
		$Q=\SI{40}{\joule}$.
	}
