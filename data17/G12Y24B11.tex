...
% ===================================================================
\begin{ex}
	\immini{Trong một số trường hợp, người ta có thể mở nút bấc chai rượu vang bằng cách hơ nóng cổ chai. Khi cổ chai được hơ nóng, không khí trong cổ chai giãn nở, tăng áp suất và đẩy nút bấc ra ngoài. Giả sử khí trong chai là xác định và coi là khí lí tưởng; ban đầu khí có áp suất bằng $\SI{1.4e5}{\pascal}$ và có nhiệt độ bằng $\SI{7}{\celsius}$. Khi khí được hơ nóng đến $\SI{87}{\celsius}$ thì nút chai bắt đầu dịch chuyển, coi thể tích khí trong chai không đổi. Áp suất của khí trong chai khi nút bấc bắt đầu dịch chuyển bằng bao nhiêu?}{\includegraphics[scale=0.2]{figs/G12Y24B11-2}}
	\choice
	{$\SI{17.4e5}{\pascal}$}
	{\True $\SI{1.8e5}{\pascal}$}
	{$\SI{1.1e5}{\pascal}$}
	{$\SI{1.6e5}{\pascal}$}
	\loigiai{$$
		\text { Đẳng tích } \dfrac{p}{T}= const \Rightarrow \dfrac{\SI{1.4e5}{\pascal}}{\SI{7}{\celsius}+273}=\dfrac{p}{\SI{87}{\celsius}+273} \Rightarrow p=\SI{1.8e5}{\pascal} \text {. }
		$$}
\end{ex}
% ===================================================================
\begin{ex}
...
% ===================================================================
\begin{ex}
	\immini{Một nhóm học sinh sử dụng các dụng cụ gồm: bình chứa khí lí tưởng có thể tích 5 lít được gắn với áp kế; nhiệt kế; bình nước để đặt bình chứa khí chìm hoàn toàn trong nước và bếp nhiệt để làm nóng nước.}
	...
	\choiceTF[t]
	{\True Áp kế được gắn với ống dẫn nhỏ tới bình khí trong bước (1) để đo áp suất của khí trong bình}
