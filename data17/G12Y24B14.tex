...
% ===================================================================
\begin{ex}
	\immini{Một ống hình trụ thẳng đứng có thể tích $V$, bên trong có một piston nhẹ có thể chuyển động không ma sát. Lúc đầu piston nằm ở chính giữa ống hình trụ và ở phía dưới piston có một lượng khí helium ở nhiệt độ $T_0$. Đun nóng từ từ cho đến lúc khí helium đạt nhiệt độ $4T_0$. Ở phía trên ống hình trụ có hai mấu để piston không bật ra khỏi ống. Cho biết áp suất khí quyển là $p_0$ và nội năng của khí helium được tính bằng công thức $U=\dfrac{3}{2}nRT$ (trong đó n là số mol khí, R là hằng số khí lí tưởng, T là nhiệt độ tuyệt đối của khí)}{\includegraphics[scale=0.3]{figs/G12Y24B14-1}}
	\choiceTF[t]
	{\True Có thể áp dụng định luật Charles với khí helium trong ống hình trụ trong quá trình piston di chuyển từ vị trí ban đầu cho đến trước khi piston chạm mấu}
	{Áp suất của khí helium trong ống luôn bằng áp suất khí quyển trong suốt quá trình tăng nhiệt độ}
	{\True Kể từ khi piston dừng lại ở mấu, tiếp tục tăng nhiệt độ cho đến lúc khí helium đạt nhiệt độ $4T_0$ thì quá trình biến đổi trạng thái của khí helium khi đó là quá trình đẳng tích}
	{\True Trong quá trình đun nóng từ từ khí helium từ nhiệt độ $T_0$ đến nhiệt độ $4T_0$, khí helium đã nhận nhiệt lượng là $\dfrac{11}{4}p_0V$}
	\loigiai{
	\begin{enumerate}[label=\alph*)]
		\item Đúng. Đun nóng từ từ nên quá trình này áp suất luôn bằng áp suất khí quyển.
