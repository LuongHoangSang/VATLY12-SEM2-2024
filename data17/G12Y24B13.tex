...
\begin{ex}
	...
	\choiceTF[t]{tăng \SI{20}{\kilo\joule}}{giảm \SI{20}{\kilo\joule}}{tăng \SI{80}{\kilo\joule}}{giảm \SI{80}{\kilo\joule}}\loigiai{}
\end{ex}
% ===================================================================
\begin{ex}
	trong một động cơ hơi nước, nếu khối khí nhận nhiệt lượng \SI{50}{\kilo\joule} và nó thực hiện một công \SI{30}{\kilo\joule} thì nội năng của khối khí
...
% ===================================================================
\begin{ex}
	\immini{Các quá trình biến đổi của một lượng khí lí tưởng được biểu diễn ở hình bên. Trong đó các đoạn thẳng BC và DA vuông góc với trục $OT$, các đoạn thẳng AB và CD đi qua gốc tọa độ.}{\includegraphics[scale=0.3]{figs/G12Y24B13-1}}
	\choiceTF[t]
	{\True Trong quá trình BC khí giãn nở đẳng nhiệt}
	{Trong quá trình CD khí nhận công từ vật khác}
	{\True Trong quá trình DA nội năng của khí không đổi}
