...
\begin{ex}
	...
	\choiceTF[t]
	{Chuyển động Brown tuân theo một số quy luật nhất định}
...
\begin{ex}
	...
	\choiceTF[t]
	{Chất khí gồm tập hợp nhiều các phân tử dao động nhiệt quanh các vị trí cân bằng của chúng}
...
\begin{ex}
	...
	\choiceTF[t]
	{Các phân tử khí được coi là chất điểm nên người ta có thể bỏ qua khối lượng các phân tử khí}
