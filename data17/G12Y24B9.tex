...
% ===================================================================
\begin{ex}
	\immini{Có thể sử dụng bộ thí nghiệm (hình bên) để tìm hiểu về mối liên hệ giữa áp suất và thể tích của một lượng khí xác định ở nhiệt độ không đổi.
		\choiceTF
		{\True Trình tự thí nghiệm: Nén (giữ nguyên nhiệt độ) khí trong xilanh; Ghi giá trị thể tích và giá trị áp suất khí; Lặp lại các thao tác}
		{\True Với kết quả thu được ở bảng bên, công thức liên hệ áp suất theo thể tích là $p=\dfrac{23}{V}$, $p$ đo bằng \si{\bar} $\left(\SI{1}{\bar}=\SI{E5}{\pascal}\right)$, $V$ đo bằng \si{\centi\meter^3}}
		{Lượng khí đã dùng trong thí nghiệm là \SI{8E-4}{\mole}}
		{Thí nghiệm này đã chứng minh được định luật Boyle}}
	{\vspace{-0.5cm}\includegraphics[scale=0.3]{figs/G12Y24B9-2}}
	\loigiai{
	\begin{enumerate}[label=\alph*)]
		\item Đúng.
		\item Đúng.
		\item Sai. $n=\dfrac{pV}{RT}\approx\dfrac{23\cdot10^{-6}\cdot10^5}{8,31\cdot\left(23,5+273\right)}\approx\SI{9.3E-4}{\mole}$.
		\item Sai. Thí nghiệm này kiểm chứng định luật Boyle.
	\end{enumerate}
	}
\end{ex}
% ===================================================================
\begin{ex}
	...
	\end{center}
	\choiceTF[t]
	{\True Số mol của khối khí trên là $\SI{0.1}{\mole}$}
...
\begin{ex}
	...
	\choiceTF[t]
	{\True Áp suất và thể tích của khí trong quả bóng tuân theo định luật Boyle}
...
% ===================================================================
\begin{ex}
	\immini{Một chiếc ghế nâng hạ bằng khí thông qua chuyển động lên xuống của xi lanh nối với mặt ghế. Thanh nén khí cố định trên đế bịt kín một lượng khí trong xi lanh (như hình vẽ). Bỏ qua ma sát giữa thanh nén và xi lanh. Tổng khối lượng của mặt ghế và xi lanh là \SI{5}{\kilogram}, tiết diện của thanh nén là \SI{20}{\centi\meter^2}. Một học sinh nặng \SI{50}{\kilogram} ngồi lên ghế (hai chân để lơ lửng không chạm mặt sàn) thì khi ổn định ghế hạ xuống \SI{15}{\centi\meter}. Coi nhiệt độ của khí trong xi lanh không đổi, áp suất khí quyển là \SI{E5}{\pascal} và $g=\SI{10}{\meter/\second^2}$.}{\includegraphics[scale=0.4]{figs/G12Y24B9-1}}
	\choiceTF[t]
	{\True Quá trình ghế hạ xuống, khí trong xi lanh nhận công}
	{\True Khi ghế để trống, áp suất của khí trong xi lanh là \SI{1.25E5}{\pascal}}
	{Khi học sinh ngồi trên ghế, áp suất của khí trong xi lanh là \SI{3.5E5}{\pascal}}
	{Khi ghế để trống, cột khí trong xi lanh dài là \SI{23.3}{\centi\meter}}
	\loigiai{}
\end{ex}
% ========================================================
\begin{ex}
	\immini{Một nhóm học sinh thực hiện dự án: "Thiết kế và chế tạo bình phun nước". Nhóm thảo luận và đưa ra thiết kế như hình vẽ. Bình phun vừa chứa nước và chứa khí có tổng thể tích là $\SI{6.00}{\liter}$, phần chứa nước có thể tích tối đa là $\SI{5.00}{\liter}$. Khi bơm khí vào bình, van $k_1$ và $k_2$ chỉ cho khí truyền qua theo một chiều đi vào. Để nước phun ra khi mở khóa k thì áp suất khí nén trong bình phải có giá trị $p \geq \SI{1.20}{\bar}$. Lần đầu thử nghiệm, nhóm cấp nước tối đa cho bình; Sau đó bơm khí đến áp suất $p_1$; Mở khóa k để nước phun, lượng nước phun ra tối đa là $\SI{0.20}{\liter}$. Bỏ qua sự thay đổi nhiệt độ khi thao tác.}{\includegraphics[scale=0.25]{figs/G12Y24B9-3}}
	\choiceTF[t]
	{\True Việc đưa ra thiết kế là một trong các bước của quá trình thực hiện dự án}
	{Trong quá trình phun nước, khối lượng riêng của khí trong bình không đổi}
	{\True Giá trị của $p_1$ là $\SI{1.44}{\bar}$}
	{Sau khi phun nước lần đầu, nhóm tiếp tục bơm khí vào bình đến áp suất $p_1$. Mở khóa k để tiếp tuc phun nước thì lượng nước phun tối đa là $\SI{0.40}{\liter}$}
	\loigiai{
	\begin{enumerate}[label=\alph*)]
		\item Đúng.
		\item Sai. Phun nước ra ngoài $\Rightarrow$ thể tích nước giảm $\Rightarrow$ thể tích khí tăng $\Rightarrow D=m/V$ thay đổi.
...
\begin{ex}
	\immini{
	Một phong vũ biểu chỉ sai vì có một ít không khí lọt vào ống. Ở áp suất khí quyển $p_0=\SI{755}{\milli\meter Hg}$ phong vũ biểu này chỉ $p_1=\SI{748}{\milli\meter Hg}$. Khi áp suất khí quyển là $p'_0=\SI{740}{\milli\meter Hg}$, phong vẽ biểu chỉ $p_2=\SI{736}{\milli\meter Hg}$. Coi diện tích mặt thuỷ ngân trong chậu lớn hơn nhiều so với tiết diện của ống, nhiệt độ không đổi. Chiều dài $\ell$ của ống phong vũ biểu bằng bao nhiêu millimet (\si{\milli\meter})?
