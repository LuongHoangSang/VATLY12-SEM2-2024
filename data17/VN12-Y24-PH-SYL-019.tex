...
\begin{tomtat}
	\subsubsection{Cảm ứng từ gây ra bởi dòng điện trong dây dẫn có hình dạng đặc biệt đặt trong không khí}
	\paragraph{Từ trường của dòng điện chạy trong dây dẫn thẳng, dài}
	\begin{center}
		\begin{tikzpicture}
			\coordinate (O) at (0,0);
...
\begin{vd}
		...
		\loigiai{Cảm ứng từ do dòng điện trong dây dẫn gây ra tại điểm cách dây đoạn $r=\SI{10}{\centi\meter}$:
...
\begin{vd}
		...
		\loigiai{Cảm ứng từ do dòng điện trong dây dẫn tròn gây ra tại tâm vòng dây:
...
\begin{vd}
		...
		\loigiai{Số vòng dây quấn trên ống dây:
			$$N=\dfrac{\ell}{\pi d}.$$
...
\begin{vd}
	...
	\loigiai{Để từ trường tổng hợp tại M bằng 0 thì:
